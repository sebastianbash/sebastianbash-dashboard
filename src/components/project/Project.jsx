...
export default function Project() {
  return (
    <div className="w-full h-4/5 bg-gray-200 rounded-[20px] mt-8 px-4 py-2 md:mt-0 md:px-8 md:py-6">
      <div className="projects-wrapper w-full h-full">
        <div className="projects-container w-full h-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-5">
